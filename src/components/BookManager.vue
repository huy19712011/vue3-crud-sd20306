...
const books = ref([
  { id: 1, title: "Book 1", description: "Description1", price: 11 },
  { id: 2, title: "Book 2", description: "Description2", price: 12 },
  { id: 3, title: "Book 3", description: "Description3", price: 13 },
]);
...
<template>
  <div class="container">
    ...
    <form class="form" @submit.prevent="handleSubmit()">
      ...
      <button @click="cancelEdit()" type="button" v-if="isEditing">Cancel</button>
    </form>
